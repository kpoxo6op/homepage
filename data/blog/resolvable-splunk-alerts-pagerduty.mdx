...
on Splunk support forum explaining how to automatically resolve PagerDuty alerts
received from Splunk.

It took me some time to understand the post, so I decided to expand it to an
easy-to-follow guide to help others.

It's remarkable that it's been 4 years since the original post but there is
...
3. [Set PagerDuty Token](#set-pagerduty-token)
4. [Configure Local Splunk](#configure-local-splunk)
5. [Run the Demo](#run-the-demo)
6. [How It Works](#how-it-works)
   - [Splunk Alert Search](#splunk-alert-search)
   - [PagerDuty API](#pagerduty-api)
   - [PagerDuty Service Orchestration](#pagerduty-service-orchestration)
