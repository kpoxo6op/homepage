...
The interestion part happens at PagerDuty Event Orchestration rule called `Autotoresolve Splunk Alerts`. PagerDuty resovles an incident if it finds `resolve` in `custom_details`.
