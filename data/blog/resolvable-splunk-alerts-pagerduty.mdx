...
Example Trigger event received by PagerDuty API:
...
Example Resolve Event with `custom_details.event_action` "resolve":
...
The Splunk Alert Search `custom_details.event_action`. It can be `Resolve` or `Trigger`.
