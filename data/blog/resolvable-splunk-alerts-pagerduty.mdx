...
The most interesting and important part happens at PagerDuty Event Orchestration rule is called `Autotoresolve Splunk Alerts`. PagerDuty resolves an incident if it finds `resolve` in `custom_details`.
