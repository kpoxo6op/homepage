...
![PagerDuty Incidents](/static/images/002-resolvable-splunk-alerts-pagerduty/pd-incidents.png)
...
![Autoresolve Splunk Alerts Rule](/static/images/002-resolvable-splunk-alerts-pagerduty/pd-autoresolve-rule.png)
...
In conclusion, this guide shows you how to auto-resolve PagerDuty alerts from Splunk using Splunk KV Store and PagerDuty Service Orchestrations. This method fills the gap in official support and streamlines incident management. Follow the steps to reduce manual work and improve efficiency, whether you're setting this up for the first time or enhancing an existing setup.