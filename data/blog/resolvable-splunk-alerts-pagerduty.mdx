...
The interestion part happens at PagerDuty Event Orchestration rule called Autotoresolve Splunk Alerts\`.

PagerDuty resovle s an incident if `custom_details.event_action` matches `resolve`.
