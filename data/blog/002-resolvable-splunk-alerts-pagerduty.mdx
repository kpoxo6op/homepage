...
Splunk Alert Search tracks the alert state via Splunk KV Store.

It calculates if it needs to return `event_action` and whether to set it to Resolve or Trigger.
