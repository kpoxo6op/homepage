...
Trigger Action sends the alert event to PagerDuty with `event_action` in message details.

Example [CEF](https://support.pagerduty.com/docs/pd-cef) event received by PagerDuty:

```json
{
  "client": "Splunk",
  "description": "Resolvable Splunk Alert Demo",
  "event_type": "trigger",
  "incident_key": "Resolvable Splunk Alert Demo",
  "service_key": "d21f971d69904008c02294259c432f71",
  "details": {
