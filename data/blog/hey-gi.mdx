...
I also asked <Definition id="definition-gpt-5-6-luna" text="GPT-5.6-Luna is a cheap model for simple tasks.">GPT-5.6-Luna</Definition> to add this post to the source files for my personal website and run the site locally on my laptop. I could then edit and inspect the post in the real website layout. It also found and added suitable images from my pCloud drive.
...
After I tested version five, Codex made version six and gave me that to try too. We repeated the process once more and reached version seven. I can see V7 on the other screen next to me. We have just tested it.
