...
I also asked <Definition id="definition-gpt-5-6-luna" text="GPT-5.6-Luna is a cheap model for simple tasks.">GPT-5.6-Luna</Definition> to put the post on my personal website and run the site locally on my laptop. This let me edit the article while seeing exactly how it would look on the real site. Luna searched my pCloud drive for suitable photos and videos and added them to the post. It also cut the inactive parts from the training video and made subtitles for it.
