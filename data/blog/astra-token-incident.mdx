...
After several poorly supervised edits, the original post went into a full autism dimension. I was editing it from my phone while walking home. GPT added about ten links to every source it could find, I suppose as proof, and explained the usage difference with several numbers carried to decimal places. I told it to remove all of that and keep one table showing how many credits Astra had burned compared with the new setup.
