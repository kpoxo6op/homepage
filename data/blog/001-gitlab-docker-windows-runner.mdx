...
![GitHub
Logo](/static/images/001-gitlab-docker-windows-runner/project-pending.png)
Format: ![GitLab project is pending](url)
...
Check what VM is doing. *Note*: Connection errors may occur because VM will
restart.
