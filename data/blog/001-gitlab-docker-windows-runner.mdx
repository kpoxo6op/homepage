...
Недавно мне довелось provision a new GitLab Runner with Docker for Windows on a Windows machine in Google Cloud.

Документация гитлаба была местами некорректная, устаревшая или недостаточно детальная. Машина с 
