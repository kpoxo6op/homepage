...
Maybe it's possible to excute Docker and Runner in \[separate\] (https://cloud.google.com/compute/docs/instances/startup-scripts/windows) scripts to make the code simpler but I could not make it working.
