...
It may be possible to execute Docker and Runner stages in [separate](https://cloud.google.com/compute/docs/instances/startup-scripts/windows) Google startup scripts to make the code simpler. I could not make it working, either Docker or Runner parts would break.
