...
Maybe it's possible to excute Docker and Runner in [separate](https://cloud.google.com/compute/docs/instances/startup-scripts/windows) Google startup scripts to make the code simpler. I could not make it working,.
