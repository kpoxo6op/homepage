...
Документация гитлаба местами некорректная, устаревшая или недостаточно детальная. Машина с раннером должна была создаваться и настраиваться в автоматическом режиме
