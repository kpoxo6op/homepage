...
Recently, I had the opportunity to provision a new GitLab Runner with Docker for Windows Executor. The Windows VM which hosted the runner was provisioned with Terraform and PowerShel.
