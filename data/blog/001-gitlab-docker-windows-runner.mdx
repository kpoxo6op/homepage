...
На пути к успеху я обнаружил, что документация гитлаба местами некорректная, устаревшая или недостаточно детальная.

К тому же, машина с раннером должна была создаваться и настраиваться в автоматическом режиме. Примеров в интернете с автоматической настройкой я не нашёл.

По этим причинам я решил опубликовать эту статью. Пусть она 
